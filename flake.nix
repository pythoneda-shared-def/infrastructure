...
{
  description = "Nix flake for pythoneda-shared-pythonlang/infrastructure";
  inputs = rec {
    esdbclient = {
  ...
  outputs = inputs:
    ...
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        repo = "infrastructure";
        version = "0.0.33";
        sha256 = "1gna6lpayaylac7zgggjqgcgx5qsbqk5h8bkciic9c8sklb4sssv";
        pname = "${org}-${repo}";
      ...
      in rec {
        ...
        devShells = rec {
          ...
          pythoneda-shared-pythonlang-infrastructure-python312 =
            shared.devShell-for {
              ...
              nixpkgs-release = nixpkgsRelease;
              package =
                packages.pythoneda-shared-pythonlang-infrastructure-python312;
          ...
          pythoneda-shared-pythonlang-infrastructure-python313 =
            shared.devShell-for {
              banner = "${
              ...
              nixpkgs-release = nixpkgsRelease;
              package =
                packages.pythoneda-shared-pythonlang-infrastructure-python313;
        ...
        packages = rec {
          ...
          pythoneda-shared-pythonlang-infrastructure-python312 =
            pythoneda-shared-pythonlang-infrastructure-for {
              esdbclient = esdbclient.packages.${system}.esdbclient-python312;
              python = pkgs.python312;
              pythoneda-shared-pythonlang-domain =
                pythoneda-shared-pythonlang-domain.packages.${system}.pythoneda-shared-pythonlang-domain-python312;
            };
          pythoneda-shared-pythonlang-infrastructure-python313 =
            pythoneda-shared-pythonlang-infrastructure-for {
              esdbclient = esdbclient.packages.${system}.esdbclient-python313;
              python = pkgs.python313;
              pythoneda-shared-pythonlang-domain =
                pythoneda-shared-pythonlang-domain.packages.${system}.pythoneda-shared-pythonlang-domain-python313;
            };
